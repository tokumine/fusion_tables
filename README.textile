...
This gem lets you easily interact with Google Fusion Tables from your Ruby application. "Blog post":http://www.tokumine.com/2010/08/10/fusion-tables-gem/.

h2. Demo and API examples
...
<pre><code>require 'fusion_tables'
