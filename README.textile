...
# Select data & RowID for publishing to Google Maps
@table.select #=> data
...
Fusion Tables is a labs product from Google. You can "read more here":http://tables.googlelabs.com/, but the key thing is that it gives you *access to the google tile mill for fast generating of google map layers across large datasets* 
